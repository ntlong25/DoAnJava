            ...
            <div class="grid">
                <div class="painel">
                    <div class="painel-header">
                        <h4 class="painel-title">Sửa thông tin khách hàng</h4>
                    </div>
                    <div class="painel-body">
                        <form action="updateuser" class="inline-form" method="post">
                            <div class="group">
                                <label for="#">Mã khách hàng</label>
                                <input type="text" name="MAKH" value="${upU.MAKH}" readonly>
                            </div>
                            <div class="group">
                                <label for="#">Tên khách hàng</label>
                                <input type="text" name="TENKH" value="${upU.TENKH}">
                            </div>
                            <div class="group">
                                <label for="#">SĐT</label>
                                <input type="text" name="SDT" value="${upU.SDT}">
                            </div>
                            <div class="group">
                                <p>&nbsp;</p>
